# python -m franka_toolkit.scripts.collection.collect_camera_pointcloud --save_path data/raw --save_name episode.npz
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_name", type=str, required=True, help="Path to the output datax.npz directory, x is belong to int such as 0,1,2...")
